...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DataAnnotationsDate
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DataAnnotationsDate))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201808281406401_DataAnnotationsDate"
            End Get
        End Property
