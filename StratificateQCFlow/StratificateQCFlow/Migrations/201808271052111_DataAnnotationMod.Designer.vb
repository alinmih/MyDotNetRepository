...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DataAnnotationMod
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DataAnnotationMod))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201808271052111_DataAnnotationMod"
            End Get
        End Property
